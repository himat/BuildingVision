...
truth_image_name, edges_image_name = tf.train.slice_input_producer([truth_filenames_tf, edges_fnames_tf], shuffle=False)
...
with tf.Session() as sess:
    ...
    for i in range(epochs):
    	...
    	if i % 1000 == 0:
            ...
            # Get next batch
            [X_truth_batch, X_edges_batch] = sess.run([truth_images_batch, edges_images_batch])
